...
-   Поддержка базовой отправки текстовых сообщений и текстовых вложений (если возможно).
-   Загрузка и отображение текста вложений или метаданных (например, имя файла).
